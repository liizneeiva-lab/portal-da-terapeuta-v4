...
export async function PATCH(
  ...
  const atualizado = atualizarTratamento(params.tratamentoId, {
    ...
    questoesTrazidas: body.questoesTrazidas ? String(body.questoesTrazidas) : undefined,
    sessoesEstimadas: body.sessoesEstimadas ? Number(body.sessoesEstimadas) : undefined,
