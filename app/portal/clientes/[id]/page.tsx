      ...
      <div className="grid md:grid-cols-3 gap-8">
            ...
            return (
              ...
              >
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-tinta-soft mt-2">
                    {tratamento.temaInicial}
                  </p>
                  ...
                  {ultima && (
                    <p className="text-xs text-tinta-muted mt-3">
                      Última sessão: {formatarData(ultima.data)} —{' '}
                      {ultima.temaPrincipal}
                    </p>
                  )}
                </div>
              </Link>
        ...
        <div className="space-y-6">
          <div className="rounded-xl3 bg-white/70 border border-bege-300/50 shadow-soft p-6">
            <h3 className="font-display text-base text-tinta mb-4">
              Dados pessoais
            </h3>
